# RollingGo Flight NPX Reference
...
## Command Guide
Commands below use the installed `rollinggo-flight` binary for readability. The latest-by-default prefix in this reference is `npx --yes rollinggo-flight@latest`.
